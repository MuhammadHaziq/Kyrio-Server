module.exports = {
    apps: [
      {
        name: "Kyrio POS API Staging Server Version 2",
        script: "./bin/www",
        error_file: "../api_server_log/staging/error.log",
        out_file: "../api_server_log/staging/out.log",
        args: "one two",
        instances: 1,
        autorestart: true,
        watch: true,
        ...
        env: {
          ...
          MONGO_LIVE_URL: "mongodb://localhost:27017/staging_kyrio_pos_v2",
          ...
          MONGO_LOCAL_URL: "mongodb://localhost:27017/staging_kyrio_pos_v2",
